        ...
        <Tabs defaultActiveKey="signIn" id="uncontrolled-tab-example">
          <TabPane tab="Sign In" key="1">
            <Form>
              ...
              <Button className="loginButton" variant="contained" color="primary" type="submit" onClick={props.signInClick}
                loading={props.signingInUser}>
                  Submit
              </Button>
              ...
              {props.signInError ? (
                <div>{props.signInError.message}</div>
              ) : null}
            </Form>
          </TabPane>
            ...
            <Form>
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: 'Please input your e-mail' }]}>
                  ...
                  addonAfter={(<div>We'll never share your email with anyone else.</div>)} />
              </Form.Item>
              <Form.Item
                name="emailOptIn"
                label="Receive weekly predictions reminder e-mails.">
                <Input type="checkbox" name="signUpEmailOptIn" onChange={props.onChangeText} label="Receive weekly predictions reminder e-mails." />
                </Form.Item>
              <Button className="loginButton" variant="contained" color="primary" type="submit" onClick={props.signUpClick}>
                Submit
              </Button>
